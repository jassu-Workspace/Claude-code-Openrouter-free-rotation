...
class OpenRouterProvider(AnthropicMessagesTransport):
    ...
    async def _validated_stream_send(
        ...
        send_response: httpx.Response | None = None
        ...
        # send_response is guaranteed non-None here because max_retries >= 1.
    ...
    async def _send_model_list_request(self) -> httpx.Response:
        ...
        # response is guaranteed non-None here because max_retries >= 1.
